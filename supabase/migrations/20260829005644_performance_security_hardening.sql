...
-- members
drop policy members_manage on public.members;
...
-- meetings
drop policy meetings_admin_manage on public.meetings;
...
drop policy classes_admin_manage on public.sunday_school_classes;
...
-- class_assignments
drop policy class_assignments_admin_manage on public.class_assignments;
...
-- meeting_assignments
drop policy meeting_assignments_admin_manage on public.meeting_assignments;
...
-- attendance_records
drop policy records_manage_take_attendance on public.attendance_records;
...
-- invitations
drop policy invitations_admin_manage on public.invitations;
drop policy invitations_read_own_email on public.invitations;
